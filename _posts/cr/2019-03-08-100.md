...
<a name="117.9b"></a>
<p class="clause" markdown="1">**117.9b** 대체 비용은 항상 선택적입니다.</p>
...
<a name="120.2d"></a>
<p class="clause" markdown="1">**120.2d** 턴을 공유하는 팀전에서, 어떤 효과가 한 명 이상의 플레이어가 카드를 뽑게 한다면, 먼저 액티브 팀의 각 플레이어가 원하는 순서대로 카드를 뽑습니다. 그리고 다음 턴 순서의 논액티브 팀 역시 동일하게 진행합니다.</p>
...
<a name="121.5"></a>
<p class="paragraph" markdown="1">**121.5.** 어떤 효과가 카운터를 "이동"하라고 한다면, 그것은 한 개체에 현재 있는 카운터를 다른 개체에 놓으라는 뜻입니다. 첫 번째와 두 번째 개체가 같은 개체라면, 아무 일도 일어나지 않습니다. 첫 번째 개체에 카운터가 없다면 아무 일도 일어나지 않습니다. 두 번째 개체는 카운터를 얻지 못합니다. 효과가 카운터를 옮기려 할 때 두 번째 개체(혹은 두 번째에 해당하는 모든 개체들)가 더 이상 현재 구역에 존재하지 않으면, 아무 일도 일어나지 않습니다. 첫 번째 개체의 카운터는 제거되지 않습니다.</p>
